...
namespace vulkanium {
	...
	void VulkaniumDevice::populateDebugMessengerCreateInfo(
	...
	void VulkaniumDevice::SetupDebugMessenger()
	{
	...
	bool VulkaniumDevice::checkValidationLayerSupport()
	{
		uint32_t layerCount;
	...
	std::vector<const char*> VulkaniumDevice::getRequiredExtensions()
	{
	...
	void VulkaniumDevice::hasGflwRequiredInstanceExtensions()
	{
	...
	bool VulkaniumDevice::checkDeviceExtensionSupport(VkPhysicalDevice device)
	{
	...
	QueueFamilyIndices VulkaniumDevice::findQueueFamilies(VkPhysicalDevice device)
	{
	...
	VkFormat VulkaniumDevice::findSupportedFormat(
	...
	void VulkaniumDevice::createBuffer(
		VkDeviceSize size,
	...
	void VulkaniumDevice::endSingleTimeCommands(VkCommandBuffer commandBuffer)
	{
	...
	void VulkaniumDevice::copyBufferToImage(
	...
	void VulkaniumDevice::createImageWithInfo(
